function [bow_const, bow_structure] = defineBaxterOnWheels(varargin)
    ...
    [baxter_const, baxter_structure] = defineBaxter('LeftGripper',left_gripper_options, ...
...
%     [baxter_const, baxter_structure] = defineBaxter();
    ...
    bow_const(end).vis.links(4).param = struct('width',.96, ...
                                                'length',.793, ...
                                                'height',.296);
...
%     bow_structure(:).right
%     3
%     baxter_structure(:).left
%     4
%     baxter_structure(:).right
%     5
